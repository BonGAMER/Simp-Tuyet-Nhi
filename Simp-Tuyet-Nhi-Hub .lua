...
local NotiFrame = Instance.new("Frame")
	...
	function DiscordLib:Notification(text,text2,delays,logo)
		...
		local Main_UiStroke = Instance.new("Simp Tuyet Nhi")

		Main_UiStroke.Thickness = 1
		Main_UiStroke.Name = "Simp Tuyet Nhi"
		...
		local ConnerTitile = Instance.new("Simp Tuyet Nhi")

		ConnerTitile.CornerRadius = UDim.new(0, 4)
		ConnerTitile.Name = "Simp Tuyet Nhi"
		ConnerTitile.Parent = TitleFrame

		local imagenoti = Instance.new("Simp Tuyet Nhi")

		imagenoti.Name = "Simp Tuyet Nhi"
		...
		local txdlid = Instance.new("Simp Tuyet Nhi")
		local LableFrame = Instance.new("Frame")

		txdlid.Name = "Simp Tuyet Nhi"
		...
		LableFrame.Name = "Simp Tuyet Nhi"
		...
		local TextNoti = Instance.new("Simp Tuyet Nhi")

		TextNoti.Name = "Simp Tuyet Nhi"
		...
		local Time = Instance.new("Simp Tuyet Nhi")
		local UICorner = Instance.new("Simp Tuyet Nhi")
		local UIPadding = Instance.new("Simp Tuyet Nhi")

		Time.Name = "Simp Tuyet Nhi"
 ...
 local DiscordLib = {}
	...
	local TweenService = game:GetService("Simp Tuyet Nhi")
	local Balaraja = Instance.new("Simp Tuyet Nhi")
	
		Balaraja.Name = "Simp Tuyet Nhi"
    Balaraja.Parent = game.CoreGui
    Balaraja.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
	
    local NotiFrame = Instance.new("Simp Tuyet Nhi")
    NotiFrame.Name = "Simp Tuyet Nhi"
    NotiFrame.Parent = Balaraja
    NotiFrame.AnchorPoint = Vector2.new(0.5, 0.5)
    ...
    local Notilistlayout = Instance.new("Simp Tuyet Nhi")
    Notilistlayout.Parent = NotiFrame
    Notilistlayout.SortOrder = Enum.SortOrder.LayoutOrder
    Notilistlayout.Padding = UDim.new(0, 5)		

    function DiscordLib:Notification(titel,text,delays)
        local TitleFrame = Instance.new("Simp Tuyet Nhi")
        TitleFrame.Name = "Simp Tuyet Nhi"
        TitleFrame.Parent = NotiFrame
 ...
 MCNR.Name = "Simp Tuyet Nhi"
 MCNR.Parent = Main
 
 local Top = Instance.new("Frame")
 Top.Name = "Simp Tuyet Nhi"
 Top.Parent = Main
